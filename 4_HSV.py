...
cv2.createTrackbar("lh", "mask", 5, 255, nothing)
cv2.createTrackbar("ls", "mask", 19, 255, nothing)
cv2.createTrackbar("lv", "mask", 64, 255, nothing)
cv2.createTrackbar("hh", "mask", 24, 255, nothing)
cv2.createTrackbar("hs", "mask", 91, 255, nothing)
cv2.createTrackbar("hv", "mask", 244, 255, nothing)
